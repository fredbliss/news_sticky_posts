...
$GLOBALS['TL_DCA']['tl_module']['palettes']['newslist'] = str_replace('numberOfItems,','news_sticky,numberOfItems,', $GLOBALS['TL_DCA']['tl_module']['palettes']['newslist']);



$GLOBALS['TL_DCA']['tl_module']['fields']['news_sticky'] = array(
    'label'                   => &$GLOBALS['TL_LANG']['tl_module']['news_sticky'],
    'exclude'                 => true,
    'inputType'               => 'checkbox',
    'eval'                    => array(),
